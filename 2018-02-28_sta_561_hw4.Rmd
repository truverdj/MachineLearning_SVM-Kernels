...
$$
I admit some uncertainty about the role of the $\eta$'s. Since, as far I can tell, they are positive numbers constrained only by $C$ in the objective functions, we conclude that the support vectors are members of the set:
$$
\{x_i: |y_i - w^Tx_i | \geq \epsilon  \}
$$
